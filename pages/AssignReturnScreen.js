            ...
            <View style={styles.layout6}>
                <DataTable style={{widthArr : [10, 10, 10]}}>
                    <DataTable.Header>
                        ...
                        <DataTable.Title style={{flex:4}} numeric>QTY</DataTable.Title>
                        ...
                        <DataTable.Cell>
                            <View style={{flexDirection: "row"}}>
                                <View style={{flexDirection: "row"}}>
                                    ...
                                    <Text style={{position: 'relative', marginTop: 10}}>Hi</Text>
                                </View>
                                <View style={{flexDirection: "row"}}>
                                    <RadioButton
                                        value="second"
                                    ...
                                    />
                                    <Text style={{position: 'relative', marginTop: 10}}>Bye</Text>
                                </View>
                            </View>
                        </DataTable.Cell>
                    </DataTable.Row>
